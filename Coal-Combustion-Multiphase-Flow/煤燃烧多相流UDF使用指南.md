...
1. **Coal-Combustion-Multiphase-Flow-Fixed.c** - 修改后的C代码
2. **fluent_c3m_udf.inp** - 配置文件
3. 本使用指南
...
1. 在代码中添加 `DEFINE_HET_RXN_RATE` 函数
2. 在 `SetValue()` 中添加参数读取
3. 在 inp 文件中添加参数
4. 重新编译UDF
...
1. 检查Fluent用户手册 UDF章节
2. 访问 Ansys Learning Forum
3. 查看示例文件: FLUENT_INSTALL/src/udf/
